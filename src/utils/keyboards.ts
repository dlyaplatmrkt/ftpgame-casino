...
export function diceBetMenu(mode: "solo" | "multi") {
  return Markup.inlineKeyboard([
    ...
    [Markup.button.callback("✏️ Своя сумма", `dice_custom_${mode}`)],
...
export function coinflipMenu() {
  return Markup.inlineKeyboard([
    ...
    [Markup.button.callback("👥 Мультиплеер", "coinflip_multi")],
...
export function coinflipBetMenu(choice: string, mode: string) {
  return Markup.inlineKeyboard([
    ...
    [Markup.button.callback("✏️ Своя сумма", `cf_custom_${mode}_${choice}`)],
...
export function rouletteSizeBetMenu(type: string) {
  return Markup.inlineKeyboard([
    ...
    [Markup.button.callback("✏️ Своя сумма", `rou_custom_${type}`)],
